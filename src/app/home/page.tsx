...
import { Zap, Target, Users, ArrowRight, BarChart, Rocket, Shield } from 'lucide-react';
      ...
      <section className="relative min-h-[calc(100vh-64px)] flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        >
          ...
          <motion.div variants={fadeUpVariant} className="flex flex-col sm:flex-row items-center gap-4">
            <Link href="/validator" className="w-full sm:w-auto btn-primary">
              Validate Your Idea
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/investors" className="w-full sm:w-auto btn-secondary">
              Explore Startups
            </Link>
          </motion.div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {features.map((f) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 shadow-glow-primary/20 bg-primary">
                  {f.icon}
                </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 flex justify-center">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <Link href="/validator" className="btn-primary text-lg px-8 py-4">
